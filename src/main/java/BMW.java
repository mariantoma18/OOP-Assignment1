/**
 * Abstract class representing a BMW car, extends the Car class and defines common properties and
 * behaviors for all BMW cars. Uses a new @param chassisPrefix to leave its mark on the
 * brand-specific chassis series.
 */
public abstract class BMW extends Car {

  protected final String chassisPrefix = "BMW";

  /**
   * Constructor to initialize a BMW car. The chassis number is prefixed with "VW" when creating a
   * new instance.
   *
  ...
  /** Starts the BMW car and resets the current distance traveled. */
  @Override
  public void start() {
    System.out.println("The BMW car stared.");
    currentDistanceTraveled = 0;
  }

  /** Stops the BMW car and calculates the total distance traveled and fuel consumption. */
  @Override
  public void stop() {
    System.out.println("The BMW car stopped.");
    totalDistanceTraveled += currentDistanceTraveled;
    System.out.println(
        "The BMW car has consumed "
  ...
  /**
   * Drives the BMW car for a specified distance in kilometers.
   *
   * @param km the distance to drive in kilometers
   */
  @Override
  public void drive(double km) {
    System.out.println("The BMW car is driven " + km + " km.");
